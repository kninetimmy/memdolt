...
var m3ToolNames = []string{
	...
	"recall", "record_command", "render", "review_pending", "search", "status", "task_add", "task_done",
}
...
func TestM3ToolsSchemasSuccessAndRefusals(t *testing.T) {
	...
	for _, deferred := range []string{"locate", "doc_add", "repo_status", "repo_pull", "repo_push", "history", "archive_transcript"} {
